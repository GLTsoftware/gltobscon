...
void usage(int exitcode, char *error, char *addl) {
        ...
        fprintf(stderr, "Usage: shutter [options] \n"
                "[options] include:\n"
                "  -h or --help    this help\n"
...
int main(int argc, char *argv[])  {
	...
	time_t dsmtimestamp;
	 ...
	 struct  poptOption optionsTable[] = {
                ...
                {"open",'o',POPT_ARG_NONE,0,'o'},
                {"close",'c',POPT_ARG_NONE,0,'c'},
                {NULL,0,0,NULL,0}
        };
	...
	if (shutterFlag==1) command_n[0]='('; /*open*/
	if (shutterFlag==0) command_n[0]=')'; /*close*/
        pmac_command_flag=0;
